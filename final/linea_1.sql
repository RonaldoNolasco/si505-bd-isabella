...
call insertarPPO ("DNI", "76146602", "Ronaldo Farid","Nolasco","Chavez","M",'2020-12-06',null,null,null);
call insertarPPO ("RUC", "17542842531", null,null,null,null,null,"Hermanos Lopez","SAA","Buen proveedor");
call insertarPPO ("DNI", "08681484", "Juan Luis Alfonso","Alva","Cuadros","M",'2020-08-06',null,null,NULL);
call insertarPPO ("RUC", "12475824753", null,null,null,null,null,"Huallpa","SAC","Buen proveedor");
call insertarPPO ("DNI", "08521411", "Franz Antony","Bendezu","Isidro","M",'2020-08-06',null,null,NULL);
call insertarPPO ("RUC", "12475542714", null,null,null,null,null,"Proveedor 1","SAC","Buen proveedor");
call insertarPPO ("DNI", "05475825", "Rosa Angelica","Ginocchio","Manutupa","F",'2020-08-06',null,null,NULL);
...
call insertarPC ("RUC", "12574547609", "Fijo" ,"5687037",'2010-01-15',null,"Telefono de casa");
select * from party_contacto;

call insertarEC ("DNI", "76146602", "Celular" ,"920796255", "RUC", "12574547609", "Fijo" ,"5687037", "Coordinación", '2020-09-09 18:30:12', '2020-09-09 18:35:17');
select * from evento_comunicacion;